...
#define webUrl "192.168.214.161"  // local ip
...
void setup() {
  ...
  String query = "/?id=" + String(deviceId) + "&machine=true";
  webSocket.begin(webUrl, port, query);
...
void loop() {
  ...
  if (Serial2.available() > 0) {
    ...
    Serial.println("Nodemcu ");          // Checking the value in serial monitor
